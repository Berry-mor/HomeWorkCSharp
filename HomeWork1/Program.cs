...
// Напишите программу, которая принимает на вход  число (N), а выходе показывает все четные числа от 1 до N.
/*int N = 0;
Console.WriteLine("Введите число: ");
...
*/
//КАК УБРАТЬ ПОСЛЕДНЮЮ ЗАПЯТУЮ В ОТВЕТЕ БЕЗ ПРЕОБРАЗОВАНИЯ.
//КАК УБРАТЬ ПОСЛЕДНЮЮ ЗАПЯТУЮ В ОТВЕТЕ БЕЗ ПРЕОБРАЗОВАНИЯ.
